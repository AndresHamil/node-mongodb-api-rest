...
export { registrarProceso } from "./registrarProceso.controller.js";
export const editarProceso = notImplemented("editarProceso");
export const eliminarProceso = notImplemented("eliminarProceso");
